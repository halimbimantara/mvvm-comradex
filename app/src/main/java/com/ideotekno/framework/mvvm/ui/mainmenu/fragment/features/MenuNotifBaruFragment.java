...
import com.ideotekno.framework.mvvm.databinding.FragmentBlogBinding;
...
import com.ideotekno.framework.mvvm.ui.feed.blogs.BlogAdapter;
import com.ideotekno.framework.mvvm.ui.feed.blogs.BlogNavigator;
...
public class MenuNotifBaruFragment extends BaseFragment<FragmentListHomeBinding, ListHomeViewModel> implements ListHomeNav {
    FragmentListHomeBinding dataBinding;
    @Inject
    ViewModelProviderFactory factory;
    private ListHomeViewModel mViewModel;

    public static MenuNotifBaruFragment newInstance() {
        Bundle args = new Bundle();
        MenuNotifBaruFragment fragment = new MenuNotifBaruFragment();
