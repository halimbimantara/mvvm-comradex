...
package com.ideotekno.framework.mvvm.ui.mainmenu.components.providers;
 ...
 */
@Module
public abstract class TabMenuFragmentProvider {
    @ContributesAndroidInjector
    abstract MenuNotifBaruFragment provideMenuOne();

    @ContributesAndroidInjector
    abstract MenuDisetujuiFragment provideMenuTwo();

    @ContributesAndroidInjector
    abstract MenuDitolakFragment provideMenuThree();

    @ContributesAndroidInjector
    abstract MenuRescheduleFragment provideMenuFour();
}
