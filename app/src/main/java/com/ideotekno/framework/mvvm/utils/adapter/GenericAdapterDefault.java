...
public abstract class GenericAdapterDefault<T, D> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context mContext;
    private ArrayList<T> mArrayList;

    public GenericAdapterDefault(Context context, ArrayList<T> arrayList) {
