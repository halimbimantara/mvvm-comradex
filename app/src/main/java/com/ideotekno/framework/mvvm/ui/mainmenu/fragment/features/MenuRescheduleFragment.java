...
public class MenuRescheduleFragment extends BaseFragment<FragmentListHomeBinding, ListHomeViewModel> implements ListHomeNav {
    FragmentListHomeBinding dataBinding;
    @Inject
    ViewModelProviderFactory factory;
    private ListHomeViewModel mViewModel;

    public static MenuRescheduleFragment newInstance() {
        Bundle args = new Bundle();
        MenuRescheduleFragment fragment = new MenuRescheduleFragment();
