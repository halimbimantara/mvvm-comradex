...
public class MenuDitolakFragment extends BaseFragment<FragmentListHomeBinding, ListHomeViewModel> implements ListHomeNav {
    FragmentListHomeBinding dataBinding;
    @Inject
    ViewModelProviderFactory factory;
    private ListHomeViewModel mViewModel;

    public static MenuDitolakFragment newInstance() {
        Bundle args = new Bundle();
        MenuDitolakFragment fragment = new MenuDitolakFragment();
